...
/* ######################## DATABASE ######################## */
//Advanced comment system comes from:http://www.plohni.com/wb/content/php/Script___advanced_comment_system.php
//and was modified by the myopenjournal team for commenting
  // Database server
  $ACS_CONFIG["db_server"] = "localhost";
  
  // Database name
  $ACS_CONFIG["db_name"] = "myopenjournal";
  
  // Database username
  $ACS_CONFIG["db_user"] = "kje5043";

  // Database password
  $ACS_CONFIG["db_password"] = "malkovich";
...
/* ##################### CONFIGURATION ###################### */
  ...
  $ACS_CONFIG["url"] = "http://p117inst10.cse.psu.edu/dev/kevans/comment/advanced_comment_system/";
  ...
  $ACS_CONFIG["anti_spam_enabled"] = false;
